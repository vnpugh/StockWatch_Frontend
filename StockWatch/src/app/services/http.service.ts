...
export class HttpService {
    ...
    public post(apiUrl: string, requestBody:any): Observable<any> {
        let httpOptions = this.setRequestHeaders();
        return this.httpClient.post(this.hostname + apiUrl, requestBody, httpOptions);
    }

    public put(apiUrl: string, requestBody?:any, requestParams?:any): Observable<any> {
        let httpOptions = this.setRequestHeaders();
        return this.httpClient.put(this.hostname + apiUrl, requestBody, httpOptions);
    }
